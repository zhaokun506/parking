...
DistanceApproachIPOPTRelaxEndSlackInterface::
    ...
    : ts_(ts), ego_(ego), xWS_(xWS), uWS_(uWS), l_warm_up_(l_warm_up),
      n_warm_up_(n_warm_up), slack_warm_up_(s_warm_up), x0_(x0), xf_(xf),
      last_time_u_(last_time_u), XYbounds_(XYbounds),
      obstacles_edges_num_(obstacles_edges_num), obstacles_A_(obstacles_A),
...
bool DistanceApproachIPOPTRelaxEndSlackInterface::get_bounds_info(
  ...
  std::cout << "variable_index after adding slack s: " << variable_index;
